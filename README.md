...
<img src="https://raw.github.com/MaxG87/konsole-papercolor/main/screenshots/manpage-and-highlight.png" width="400"/>
...
Color1Intense | <ul><li>font colour if Zsh cannot find a command</li><li>font colour of remote branches in output of `git log`</li><li>archives (`*.xz`, `*.zst`, etc.) in output of `ls` or `exa`</li></ul>
